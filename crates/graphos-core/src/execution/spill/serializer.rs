    ...
    match tag[0] {
        ...
        TAG_MAP => {
            ...
            for _ in 0..len {
                ...
                map.insert(graphos_common::types::PropertyKey::new(key_str), val);
            }
...
mod tests {
    ...
    fn test_serialize_timestamp() {
        let ts = graphos_common::types::Timestamp::from_micros(1234567890);
    ...
    fn test_serialize_map() {
        let mut map = BTreeMap::new();
        map.insert(
            graphos_common::types::PropertyKey::new("name"),
            Value::String(Arc::from("Alice")),
        );
        map.insert(
            graphos_common::types::PropertyKey::new("age"),
            Value::Int64(30),
        );
